...
\chapter{How did Coleman and Weinberg do it?}\label{CWchapter}
...
%\todo{M parameter }
The parameter $M$ taken is arbitrary and will cancel out in the final potential, as we will 
soon see. \\
The resulting $C$ is:
\begin{align}
...
\left(\ln\frac{e^2\varphi_c^2}{\Lambda^2}-\frac{1}{2}\right),
\end{align}
and after canceling the renormalised potential is:
\begin{align}
V = &\frac{\lambda}{4!}\varphi_c^4
